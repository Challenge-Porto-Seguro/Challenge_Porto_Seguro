...
class LoginTest {
    ...
    void se_nome_invalido_validaDados_retorna_erro() {
        Login mockLogin = new Usuario("Pedro", "12345678909", "ph@gmail.com", "12345678", mockEndereco);
    ...
    void se_adiciona_orcamento_get_orcamento_size_igual_1() {
        ...
        mockLogin.addOrcamento(mockOrcamento);
        Assertions.assertEquals(1, mockLogin.getOrcamentos().size());
    }
    ...
    void se_remove_orcamento_get_orcamento_size_igual_0() {
        Login mockLogin = new Usuario("Pedro", "12345678909", "ph@gmail.com", "12345678", mockEndereco);
        Orcamento mockOrcamento = new Orcamento();
        mockLogin.removeOrcamento(mockOrcamento);
        Assertions.assertEquals(0, mockLogin.getOrcamentos().size());
    }
